...
//NEW WAY
const wrapper = document.querySelector(".wrapper") // html doc. dagi barcha wrapperlarni qaytaradi
console.log(wrapper)

const hearts = wrapper.querySelectorAll(".heart") // wrapper ichidagi barcha heart larni qaytaradi
console.log(hearts)
